function removeExtraDoms() {
  ...
  try {
    fileTree &&
      fileTree.parentElement.parentElement.parentElement.parentElement.remove();
  } catch (e) {}
  ...
  if (pagehead_actions) {
    ...
    notifications &&
      notifications.innerText.trim() === "Notifications" &&
  ...
  try {
    document
      .querySelector("button.react-tree-toggle-button-with-indicator")
  ...
  // 移除代码框右上角的控制按钮组
  let code_actions = document.querySelector(
    "div.react-blob-header-edit-and-raw-actions",
  );
